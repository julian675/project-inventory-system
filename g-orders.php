...
<nav>
    ...
    <div class="sidebar">
        ...
        <div class="dashboard" onclick="window.location.href='g-dashboard.php'">
          <i class="fas fa-chart-line sidebar-icon"></i>
          <div class="menu-label">Dashboard</div> 
        </div>
        <div class="instock" onclick="window.location.href='g-In Stock.php'">
            <i class="fas fa-boxes sidebar-icon"></i>
            <div class="menu-label">In Stock</div> 
        </div>
        <div class="products" onclick="window.location.href='g-products.php'">
            <i class="fas fa-tags sidebar-icon"></i>
            <div class="menu-label">Products</div> 
        </div>
        <div class="sales" onclick="window.location.href='g-sales.php'">
          ...
          <div class="users" onclick="window.location.href='g-users.php'">
            <i class="fas fa-users sidebar-icon"></i>
            <div class="menu-label">Users</div>
          </div>
          <div class="invoice" onclick="window.location.href='g-invoice.php'">
